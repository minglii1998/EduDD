...
if __name__ == "__main__":
    preprocess_dataset('split_pub/Cambridge_mcq_test_pub.json', 'EduAgent_related/Cambridge_mcq_test_pub_Qformat.json')
    preprocess_dataset('split_pub/Cambridge_mcq_train_pub.json', 'EduAgent_related/Cambridge_mcq_train_pub_Qformat.json')